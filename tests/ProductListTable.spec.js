...
test.describe("Store App Tests", () => {
  ...
  test("Mengarahkan ke halaman update-product saat tombol Update diklik", async ({
    page,
  }) => {
    ...
    await expect(page).toHaveURL(
      /http:\/\/localhost:5173\/update-product\/\d+/
    );
  ...
  test("Memungkinkan export data produk ke file Excel", async ({
    page,
  }) => {
